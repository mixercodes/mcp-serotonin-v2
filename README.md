...
A file-based [Model Context Protocol](https://modelcontextprotocol.io/) server that connects Claude Code to the [Serotonin](https://serotonin.gg/) Roblox scripting runtime. It replaces the original WebSocket bridge with a crash-safe filesystem IPC design.
